...
namespace Server.Engines.MyRunUO
{
	public class Config
	{
		...
		public static string DatabaseServer			= "sql.strzaly.nazwa.pl";
		public static string DatabaseName			= "strzaly_21";
		public static string DatabaseUserID			= "strzaly_21";
		public static string DatabasePassword		= "FEanor_69";
