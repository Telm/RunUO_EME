...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		{
			get { return 1044005; } // <CENTER>KRAWIECTWO</CENTER>
		}
...
//private DefTailoring() : base( 6, 6, 1.7 )// base( 1, 1, 4.5 )
		{
		}
		...
		public override void InitCraftList()
		{
			...
			if( Core.SE )
			{
				index = AddCraft( typeof( Hood ), 1011375, 1030202, 80.0, 105.0, typeof( Cloth ), 1044286, 13, 1044287 );
				SetNeededExpansion( index, Expansion.SE );

				index = AddCraft( typeof( PirateHat ), 1011375, 1030211, 60.0, 85.0, typeof( Cloth ), 1044286, 12, 1044287 );	
				SetNeededExpansion( index, Expansion.SE );
			}
			#endregion
...
/*
			...
			AddCraft( typeof( StuddedCap ), 1015300, 3010200, 10.2, 40.2, typeof( Leather ), 1044462, 4, 1044463 );
