...
namespace Server.Engines.Craft
{
	public class DefBlacksmithy : CraftSystem
	{
		...
		{
			get { return 1044002; } // <CENTER>KOWALSTWO</CENTER>
		}
		...
		//private DefBlacksmithy() : base( 6, 6, 1.70 )// base( 1, 2, 1.7 )
	...
	/* 		if ( Core.AOS ) // exact pre-aos functionality unknown
			...
			AddCraft( typeof( HornedHelm ), 1011079, 1025134, 37.9, 87.9, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddCraft( typeof( PlateHelm ), 1011079, 1025138, 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
			AddCraft( typeof( GreatHelm ), 1011079, 1025138, 62.6, 112.6, typeof( IronIngot ), 1044036, 15, 1044037 );
...
/* 			if( Core.SE )
			...
			AddCraft( typeof( GreatHammerPick ), 1011084, "great hammer pick", 34.2, 84.2, typeof( IronIngot ), 1044036, 16, 1044037 );
			...
			AddCraft( typeof( GreatMaul ), 1011084, "great maul", 19.4, 69.4, typeof( IronIngot ), 1044036, 10, 1044037 );
