...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		{
			get { return 1044007; } // <CENTER>MAJSTERKOWANIE</CENTER>
		}
		...
		//private DefTinkering() : base( 3, 3, 1.7 )// base( 1, 1, 3.0 )
		{
		}
		...
		public override void InitCraftList()
		{
			...
			SetSubRes2( typeof( Log ), 1072643 );

			// Add every material you want the player to be able to choose from
			// This will override the overridable material	TODO: Verify the required skill amount
			//AddSubRes2( typeof( Log ), 1072643, 00.0, 1044041, 1072652 );
			//AddSubRes2( typeof( OakLog ), 1072644, 65.0, 1044041, 1072652 );
			//AddSubRes2( typeof( AshLog ), 1072645, 80.0, 1044041, 1072652 );
			//AddSubRes2( typeof( YewLog ), 1072646, 95.0, 1044041, 1072652 );
			//AddSubRes2( typeof( HeartwoodLog ), 1072647, 100.0, 1044041, 1072652 );
			//AddSubRes2( typeof( BloodwoodLog ), 1072648, 100.0, 1044041, 1072652 );
			//AddSubRes2( typeof( FrostwoodLog ), 1072649, 100.0, 1044041, 1072652 );
