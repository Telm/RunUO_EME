...
namespace Server.Engines.Harvest
{
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			oreAndStone.EffectCounts = new int[]{ 6 };
			...
			res = new HarvestResource[]
				{
					new HarvestResource( 00.0, 00.0, 100.0, 1007072, typeof( IronOre ),			typeof( Granite ) ), //iron
					new HarvestResource( 65.0, 25.0, 105.0, 1007073, typeof( DullCopperOre ),	typeof( DullCopperGranite ),	typeof( DullCopperElemental ) ), //alcam
					new HarvestResource( 70.0, 30.0, 110.0, 1007074, typeof( ShadowIronOre ),	typeof( ShadowIronGranite ),	typeof( ShadowIronElemental ) ), //evyth
					new HarvestResource( 75.0, 35.0, 115.0, 1007075, typeof( CopperOre ),		typeof( CopperGranite ),		typeof( CopperElemental ) ), //celeb
					new HarvestResource( 80.0, 40.0, 120.0, 1007076, typeof( BronzeOre ),		typeof( BronzeGranite ),		typeof( BronzeElemental ) ), //mal
					new HarvestResource( 85.0, 45.0, 125.0, 1007077, typeof( GoldOre ),			typeof( GoldGranite ),			typeof( GoldenElemental ) ), //steel
					new HarvestResource( 90.0, 50.0, 130.0, 1007078, typeof( AgapiteOre ),		typeof( AgapiteGranite ),		typeof( AgapiteElemental ) ), //tasarang
					new HarvestResource( 95.0, 55.0, 135.0, 1007079, typeof( VeriteOre ),		typeof( VeriteGranite ),		typeof( VeriteElemental ) ), //erythmal
					new HarvestResource( 99.0, 59.0, 139.0, 1007080, typeof( ValoriteOre ),		typeof( ValoriteGranite ),		typeof( ValoriteElemental ) ) //mithril
				};

			veins = new HarvestVein[]
				{
					new HarvestVein( 20.0, 0.0, res[0], null   ), // iron
					new HarvestVein( 16.0, 0.5, res[1], res[0] ), // alcam
					new HarvestVein( 15.0, 0.5, res[2], res[0] ), // evyth
					new HarvestVein( 14.0, 0.5, res[3], res[0] ), // celeb
					new HarvestVein( 13.0, 0.5, res[4], res[0] ), // mal
					new HarvestVein( 10.0, 0.5, res[5], res[0] ), // steel
					new HarvestVein( 06.0, 0.5, res[6], res[0] ), // tasarang
					new HarvestVein( 06.0, 0.5, res[7], res[0] ), // erythmal
					new HarvestVein( 00.0, 0.5, res[8], res[0] )  // mithril
				};
