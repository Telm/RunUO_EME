...
namespace Server.Engines.Harvest
{
	public class Lumberjacking : HarvestSystem
	{
		...
		private Lumberjacking()
		{
			...
			lumber.EffectCounts = (Core.AOS ? new int[]{ 6 } : new int[]{ 1, 2, 2, 2, 3 });
			...
			if ( Core.ML )
			{
				res = new HarvestResource[]
				{
				  // NUMBERS BELOW ARE...
					...
					new HarvestResource(  50.0, 50.0, 100.0, 1072541, typeof( OakLog ) ),
					new HarvestResource(  60.0, 60.0, 110.0, 1072542, typeof( AshLog ) ),
					new HarvestResource(  70.0, 70.0, 120.0, 1072543, typeof( YewLog ) ),
					new HarvestResource( 80.0, 80.0, 130.0, 1072544, typeof( HeartwoodLog ) ),
					new HarvestResource( 90.0, 90.0, 135.0, 1072545, typeof( BloodwoodLog ) ),
					new HarvestResource( 99.0, 99.0, 139.0, 1072546, typeof( FrostwoodLog ) ),
				};
                    // NUMBERS BELOW ARE...
                    // 1ST Vein Chance
