...
//			RegisterMap( 0, 0, 0, 6144, 4049, 4, "Felucca",		MapRules.FeluccaRules );
//			RegisterMap( 1, 1, 0, 6144, 4049, 0, "Trammel",		MapRules.TrammelRules );
			RegisterMap( 0, 0, 0, 6144, 4096, 4, "Felucca",		MapRules.FreeMovement );
			RegisterMap( 1, 1, 0, 6144, 4096, 0, "Trammel",		MapRules.FreeMovement );
