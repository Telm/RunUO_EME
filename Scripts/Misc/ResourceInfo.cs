...
namespace Server.Items
{
	...
	public class CraftAttributeInfo
	{
		...
		static CraftAttributeInfo()
		{
			...
			CraftAttributeInfo dullCopper = DullCopper = new CraftAttributeInfo();  //Ang
			...
			CraftAttributeInfo shadowIron = ShadowIron = new CraftAttributeInfo(); //Evyth
			...
			CraftAttributeInfo copper = Copper = new CraftAttributeInfo(); //Celeb
			...
			CraftAttributeInfo bronze = Bronze = new CraftAttributeInfo(); //Mal
			...
			CraftAttributeInfo golden = Golden = new CraftAttributeInfo(); //Steel
			...
			CraftAttributeInfo agapite = Agapite = new CraftAttributeInfo(); //Tasarang
			...
			CraftAttributeInfo verite = Verite = new CraftAttributeInfo(); //Erythmal
			...
			CraftAttributeInfo valorite = Valorite = new CraftAttributeInfo(); //Mithril
	...
	{
		private static CraftResourceInfo[] m_MetalInfo = new CraftResourceInfo[]  // Dodac kolorki, byc moze bedzie zle craftatributeinfo
			{
				new CraftResourceInfo( 0x000, 1053109, "Iron",			CraftAttributeInfo.Blank,		CraftResource.Iron,				typeof( IronIngot ),		typeof( IronOre ),			typeof( Granite ) ),
				new CraftResourceInfo( 0x75B, 1053108, "Alcam",	CraftAttributeInfo.DullCopper,	CraftResource.DullCopper,		typeof( DullCopperIngot ),	typeof( DullCopperOre ),	typeof( DullCopperGranite ) ),
				new CraftResourceInfo( 0x46E, 1053107, "Evyth",	CraftAttributeInfo.ShadowIron,	CraftResource.ShadowIron,		typeof( ShadowIronIngot ),	typeof( ShadowIronOre ),	typeof( ShadowIronGranite ) ),
				new CraftResourceInfo( 0x98A, 1053106, "Celeb",		CraftAttributeInfo.Copper,		CraftResource.Copper,			typeof( CopperIngot ),		typeof( CopperOre ),		typeof( CopperGranite ) ),
				new CraftResourceInfo( 0x9B8, 1053105, "Mal",		CraftAttributeInfo.Bronze,		CraftResource.Bronze,			typeof( BronzeIngot ),		typeof( BronzeOre ),		typeof( BronzeGranite ) ),
				new CraftResourceInfo( 0x579, 1053104, "Steel",			CraftAttributeInfo.Golden,		CraftResource.Gold,				typeof( GoldIngot ),		typeof( GoldOre ),			typeof( GoldGranite ) ),
				new CraftResourceInfo( 0x9AC, 1053103, "Tasarang",		CraftAttributeInfo.Agapite,		CraftResource.Agapite,			typeof( AgapiteIngot ),		typeof( AgapiteOre ),		typeof( AgapiteGranite ) ),
				new CraftResourceInfo( 0x7E2, 1053102, "Erythmal",		CraftAttributeInfo.Verite,		CraftResource.Verite,			typeof( VeriteIngot ),		typeof( VeriteOre ),		typeof( VeriteGranite ) ),
				new CraftResourceInfo( 0x7A1, 1053101, "Mithril",		CraftAttributeInfo.Valorite,	CraftResource.Valorite,			typeof( ValoriteIngot ),	typeof( ValoriteOre ),		typeof( ValoriteGranite ) ),
			};
		...
		private static CraftResourceInfo[] m_WoodInfo = new CraftResourceInfo[] // Zmienic nazwy drewna
			{
				new CraftResourceInfo( 0x000, 1011542, "Normal",		CraftAttributeInfo.Blank,		CraftResource.RegularWood,	typeof( Log ),			typeof( Board ) ),
				new CraftResourceInfo( 0x1C2, 1072533, "Oak",			CraftAttributeInfo.OakWood,		CraftResource.OakWood,		typeof( OakLog ),		typeof( OakBoard ) ),
				new CraftResourceInfo( 0x27C, 1072534, "Ash",			CraftAttributeInfo.AshWood,		CraftResource.AshWood,		typeof( AshLog ),		typeof( AshBoard ) ),
				new CraftResourceInfo( 0x3EA, 1072535, "Yew",			CraftAttributeInfo.YewWood,		CraftResource.YewWood,		typeof( YewLog ),		typeof( YewBoard ) ),
				new CraftResourceInfo( 0x610, 1072536, "Heartwood",		CraftAttributeInfo.Heartwood,	CraftResource.Heartwood,	typeof( HeartwoodLog ),	typeof( HeartwoodBoard ) ),
				new CraftResourceInfo( 0x6BA, 1072538, "Bloodwood",		CraftAttributeInfo.Bloodwood,	CraftResource.Bloodwood,	typeof( BloodwoodLog ),	typeof( BloodwoodBoard ) ),
				new CraftResourceInfo( 0x445, 1072539, "Frostwood",		CraftAttributeInfo.Frostwood,	CraftResource.Frostwood,	typeof( FrostwoodLog ),	typeof( FrostwoodBoard ) )
			};
	...
	public class OreInfo                                                                                          //Kolorki
	{
		public static readonly OreInfo Iron			= new OreInfo( 0, 0x000, "Iron" );
		public static readonly OreInfo DullCopper	= new OreInfo( 1, 0x973, "DullCopper" );
		public static readonly OreInfo ShadowIron	= new OreInfo( 2, 0x966, "ShadowIron" );
