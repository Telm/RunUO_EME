		...
		private static string[] m_Messages = ( TestCenter.Enabled ?
			...
			new string[]
				{	//Yes, this message is a pathetic message, It's suggested that you change it.
					"Witaj na beta testach Endore RunUO.",
					"Testuj, sprawdzaj! Znaleziony blad badz sugestie co do zmian umieszczaj na forum! Sprawiaj by Endore stalo sie jeszcze lepsze!."
				} );
