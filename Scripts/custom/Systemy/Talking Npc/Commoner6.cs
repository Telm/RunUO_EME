...
{
    public class Commoner6 : BaseCreature
    {
        ...
        [Constructable]
        public Commoner6() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 ) 
        {
            SetStr( 10, 30 );
            SetDex( 10, 30 );
            SetInt( 10, 30 );
	    ...
	    SetSkill( SkillName.Camping, 60.0, 70.0 );
	    SetSkill( SkillName.Tracking, 60.0, 70.0 );
	   
            SpeechHue = Utility.RandomDyedHue();
            Title = string.Empty;//Commoner6.Titles[Utility.Random( 0, Titles.Length )];
        ...
        public Commoner6( Serial serial ) : base( serial )
        {
        }
