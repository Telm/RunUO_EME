...
{
    public class Commoner2 : BaseCreature
    {
        ...
        [Constructable]
        public Commoner2() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 ) 
        {
            SetStr( 10, 30 );
            SetDex( 10, 30 );
            SetInt( 10, 30 );
	    ...
	    SetSkill( SkillName.Carpentry, 60.0, 70.0 );
            ...
            Title = string.Empty;//Commoner2.Titles[Utility.Random( 0, Titles.Length )];
        ...
        public Commoner2( Serial serial ) : base( serial )
        {
        }
