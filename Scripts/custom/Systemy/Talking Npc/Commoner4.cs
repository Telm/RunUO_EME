...
{
    public class Commoner4 : BaseCreature
    {
        ...
        [Constructable]
        public Commoner4() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 ) 
        {
            SetStr( 10, 30 );
            SetDex( 10, 30 );
            SetInt( 10, 30 );
	    ...
	    SetSkill( SkillName.ArmsLore, 60.0, 70.0 );
	    SetSkill( SkillName.Begging, 60.0, 70.0 );
	   
            SpeechHue = Utility.RandomDyedHue();
            Title = string.Empty;//Commoner4.Titles[Utility.Random( 0, Titles.Length )];
        ...
        public Commoner4( Serial serial ) : base( serial )
        {
        }
