...
{
    public class Commoner1 : BaseCreature
    {
        ...
        [Constructable]
        public Commoner1() : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 ) 
        {
            SetStr( 10, 30 );
            SetDex( 10, 30 );
            SetInt( 10, 30 );
	    ...
	    SetSkill( SkillName.ItemID, 60.0, 70.0 );
	    SetSkill( SkillName.Mining, 60.0, 70.0 );
	   
            SpeechHue = Utility.RandomDyedHue();
            Title = string.Empty;//Commoner1.Titles[Utility.Random( 0, Titles.Length )];
