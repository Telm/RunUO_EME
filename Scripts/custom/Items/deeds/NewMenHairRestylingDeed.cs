...
{
	public class NewMenHairRestylingDeed : Item
	{
		public override int LabelNumber{ get{ return 1041061; } } // a coupon for a free hair restyling

		[Constructable]
		public NewMenHairRestylingDeed() : base( 0x14F0 )
		{
		    Name = "Nowe Szkice fryzur meskich";
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public NewMenHairRestylingDeed( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump : Gump
		{
			...
			private NewMenHairRestylingDeed m_Deed;

			public InternalGump( Mobile from, NewMenHairRestylingDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
...
*/
			int[][] HumanArray = /* why on earth cant these utilies be consistent with hex/dec */
			{
				...
				new int[] { 1011052, 1011052, 0x265F, 0x265F, 0xc52e, 0xc52e }, // 1
				new int[] { 1011053, 1011053, 0x2660, 0x2660, 0xc586, 0xc586 }, // 2
				new int[] { 1011054, 1011054, 0x2661, 0x2661, 0xc57f, 0xc57f }, // 3
				new int[] { 1011055, 1011055, 0x2662, 0x2662, 0xc57e, 0xc57e }, // 4
				new int[] { 1011047, 1011047, 0x2663, 0x2663, 0xc578, 0xc578 }, // 5
				new int[] { 1074393, 1011048, 0x2664, 0x2664, 0xc569, 0xc569 }, // 6
				new int[] { 1011049, 1011049, 0x2665, 0x2665, 0xc568, 0xc568 }, // 7
				new int[] { 1011050, 1011050, 0x2666, 0x2666, 0xc666, 0xc666 }, // 8
