...
namespace Server.Items
{
	...
	public class Corpse : Container, ICarvable
	{
        ...
        //jak dlugo po wskrzeszeniu sa ciala
        //dla potworow
        //private static TimeSpan m_CDefaultDecayTime = TimeSpan.FromMinutes(7.0);
        //private static TimeSpan m_CBoneDecayTime = TimeSpan.FromMinutes(7.0);
        //dla playermobile'ow
        //todo
        ...
        private string DefaultNameCorpse(Mobile from)
        {
			...
			: base( 0x2006 )
		{
            ...
            if (owner is PlayerMobile)
            {
                Name = DefaultNameCorpse(owner);
                m_CorpseName = DefaultNameCorpse(owner);
        ...
        /*public void CorpseDelay(Mobile owner)
        {       
            if (owner is PlayerMobile)
            {
                if (!owner.CheckAlive(false))
                {
                    owner.SendAsciiMessage("juz zaczyna sie odliczanie ");
                    BeginDecay(m_DefaultDecayTime);
                }
                else
                {
            ...
            {
                BeginDecay(m_DefaultDecayTime);
                //BeginDecay(m_CDefaultDecayTime);
            }
        }*/
