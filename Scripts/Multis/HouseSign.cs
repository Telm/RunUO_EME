...
namespace Server.Multis
{
	public class HouseSign : Item
	{
        ...
        private string DefaultNameHouse(Mobile from)
        {
		...
		public override void GetProperties( ObjectPropertyList list )
		{
            ...
            //if (m_Owner.Owner is PlayerMobile)
            //{
               list.Add(1061639, Utility.FixHtml(GetName())); // Name: ~1_NAME~
               list.Add(1061640, (m_Owner == null || m_Owner.Owner == null) ? "nobody" : DefaultNameHouse(m_Owner.Owner)); // Owner: ~1_OWNER~
            //}
            //else
            //{
            //    list.Add(1061639, Utility.FixHtml(GetName())); // Name: ~1_NAME~
