...
namespace Server
{
	...
	public abstract class Race
	{
		...
		private string m_Name, m_PluralName, m_ShortName,m_UnknownName;
		private LanguageKnowledge m_BasicRaceLanguagesKnowledge;
		...
		public LanguageKnowledge BasicRaceLanguagesKnowlegde{get{ return m_BasicRaceLanguagesKnowledge;}}
		public int LanguageKnowledgeValue(int languageIndex){
			if(BasicRaceLanguagesKnowlegde == null){
				Console.WriteLine("Knowledge ew null");
				return 0;
			}
			return BasicRaceLanguagesKnowlegde.LanguageKnowledgeValue(languageIndex);
		}
		protected Race( int raceID, int raceIndex, string name, string pluralName,string shortName, string unknownName, int maleBody, int femaleBody, int maleGhostBody, int femaleGhostBody, Expansion requiredExpansion, LanguageKnowledge basicKnowledge )
		{
			m_RaceID = raceID;
		...
		m_ShortName = shortName;
			...
			m_BasicRaceLanguagesKnowledge = basicKnowledge;
		}
		...
		//eme modifications 
		public abstract double GetWeightModifier();
		public abstract bool HasRacialNightSight();
